...
export default function Hero() {
    ...
    return (
        <section className="relative pt-24 pb-12 lg:pt-48 lg:pb-32 px-6 border-b border-gray-200 overflow-hidden bg-background-alt">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    <div className="lg:col-span-7 flex flex-col gap-4 lg:gap-6">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[0.95] tracking-tight text-text-main">
                        ...
                        <p className="text-base md:text-xl text-text-secondary max-w-xl font-body leading-relaxed">
                            {hero.description}
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 mt-2 lg:mt-4">
                            <Link
                    ...
                    <div className="lg:col-span-5 relative h-full min-h-[250px] lg:min-h-[300px] flex items-center justify-center lg:justify-end hidden md:flex">
                        <div className="relative w-full max-w-md aspect-square bg-gray-50 rounded-2xl border border-gray-200 p-6 lg:p-8 flex flex-col justify-between shadow-sm">
                            <div className="flex justify-between items-center border-b border-gray-200 pb-3 lg:pb-4 mb-3 lg:mb-4">
                            ...
                            <div className="space-y-2 lg:space-y-3 font-mono text-sm text-gray-500">
